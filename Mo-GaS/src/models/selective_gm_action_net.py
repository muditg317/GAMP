...
class SelectiveGazeAndMotion_ActionNet(MoGaS_Gazed_ActionNet):
  def __init__(self, **kwargs):
    super(SelectiveGazeAndMotion_ActionNet, self).__init__(**kwargs)
  ...
  def loss_fn(self, loss_, acts, targets, x_g=None, x_m=None):
