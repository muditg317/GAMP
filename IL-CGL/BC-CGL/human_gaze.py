...
class Human_Gaze_Predictor:
    ...
    def predict_and_save(self, imgs):
        ...
        np.savez_compressed("predicted_gaze_heatmaps/human_gaze_" + self.game_name, heatmap=self.preds[:,:,:,0])
        print("Done. Output is:")
        print(" %s" % "predicted_gaze_heatmaps/human_gaze_" + self.game_name + '.npz')
